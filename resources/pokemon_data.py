...
KANTO = [
    {'id': '001', 'name': 'Bulbasaur', 'number': '1'},
    {'id': '002', 'name': 'Ivysaur', 'number': '2'},
    {'id': '003', 'name': 'Venusaur', 'number': '3'},
    {'id': '004', 'name': 'Charmander', 'number': '4'},
    {'id': '005', 'name': 'Charmeleon', 'number': '5'},
    {'id': '006', 'name': 'Charizard', 'number': '6'},
    {'id': '007', 'name': 'Squirtle', 'number': '7'},
    {'id': '008', 'name': 'Wartortle', 'number': '8'},
    {'id': '009', 'name': 'Blastoise', 'number': '9'},
    {'id': '010', 'name': 'Caterpie', 'number': '10'},
    {'id': '011', 'name': 'Metapod', 'number': '11'},
    {'id': '012', 'name': 'Butterfree', 'number': '12'},
    {'id': '013', 'name': 'Weedle', 'number': '13'},
    {'id': '014', 'name': 'Kakuna', 'number': '14'},
    {'id': '015', 'name': 'Beedrill', 'number': '15'},
    {'id': '016', 'name': 'Pidgey', 'number': '16'},
    {'id': '017', 'name': 'Pidgeotto', 'number': '17'},
    {'id': '018', 'name': 'Pidgeot', 'number': '18'},
    {'id': '019', 'name': 'Rattata', 'number': '19'},
    {'id': '020', 'name': 'Raticate', 'number': '20'},
    {'id': '021', 'name': 'Spearow', 'number': '21'},
    {'id': '022', 'name': 'Fearow', 'number': '22'},
    {'id': '023', 'name': 'Ekans', 'number': '23'},
    {'id': '024', 'name': 'Arbok', 'number': '24'},
    {'id': '025', 'name': 'Pikachu', 'number': '25'},
    {'id': '026', 'name': 'Raichu', 'number': '26'},
    {'id': '027', 'name': 'Sandshrew', 'number': '27'},
    {'id': '028', 'name': 'Sandslash', 'number': '28'},
    {'id': '029', 'name': 'Nidoran♀', 'number': '29'},
    {'id': '030', 'name': 'Nidorina', 'number': '30'},
    {'id': '031', 'name': 'Nidoqueen', 'number': '31'},
    {'id': '032', 'name': 'Nidoran♂', 'number': '32'},
    {'id': '033', 'name': 'Nidorino', 'number': '33'},
    {'id': '034', 'name': 'Nidoking', 'number': '34'},
    {'id': '035', 'name': 'Clefairy', 'number': '35'},
    {'id': '036', 'name': 'Clefable', 'number': '36'},
    {'id': '037', 'name': 'Vulpix', 'number': '37'},
    {'id': '038', 'name': 'Ninetales', 'number': '38'},
    {'id': '039', 'name': 'Jigglypuff', 'number': '39'},
    {'id': '040', 'name': 'Wigglytuff', 'number': '40'},
    {'id': '041', 'name': 'Zubat', 'number': '41'},
    {'id': '042', 'name': 'Golbat', 'number': '42'},
    {'id': '043', 'name': 'Oddish', 'number': '43'},
    {'id': '044', 'name': 'Gloom', 'number': '44'},
    {'id': '045', 'name': 'Vileplume', 'number': '45'},
    {'id': '046', 'name': 'Paras', 'number': '46'},
    {'id': '047', 'name': 'Parasect', 'number': '47'},
    {'id': '048', 'name': 'Venonat', 'number': '48'},
    {'id': '049', 'name': 'Venomoth', 'number': '49'},
    {'id': '050', 'name': 'Diglett', 'number': '50'},
    {'id': '051', 'name': 'Dugtrio', 'number': '51'},
    {'id': '052', 'name': 'Meowth', 'number': '52'},
    {'id': '053', 'name': 'Persian', 'number': '53'},
    {'id': '054', 'name': 'Psyduck', 'number': '54'},
    {'id': '055', 'name': 'Golduck', 'number': '55'},
    {'id': '056', 'name': 'Mankey', 'number': '56'},
    {'id': '057', 'name': 'Primeape', 'number': '57'},
    {'id': '058', 'name': 'Growlithe', 'number': '58'},
    {'id': '059', 'name': 'Arcanine', 'number': '59'},
    {'id': '060', 'name': 'Poliwag', 'number': '60'},
    {'id': '061', 'name': 'Poliwhirl', 'number': '61'},
    {'id': '062', 'name': 'Poliwrath', 'number': '62'},
    {'id': '063', 'name': 'Abra', 'number': '63'},
    {'id': '064', 'name': 'Kadabra', 'number': '64'},
    {'id': '065', 'name': 'Alakazam', 'number': '65'},
    {'id': '066', 'name': 'Machop', 'number': '66'},
    {'id': '067', 'name': 'Machoke', 'number': '67'},
    {'id': '068', 'name': 'Machamp', 'number': '68'},
    {'id': '069', 'name': 'Bellsprout', 'number': '69'},
    {'id': '070', 'name': 'Weepinbell', 'number': '70'},
    {'id': '071', 'name': 'Victreebel', 'number': '71'},
    {'id': '072', 'name': 'Tentacool', 'number': '72'},
    {'id': '073', 'name': 'Tentacruel', 'number': '73'},
    {'id': '074', 'name': 'Geodude', 'number': '74'},
    {'id': '075', 'name': 'Graveler', 'number': '75'},
    {'id': '076', 'name': 'Golem', 'number': '76'},
    {'id': '077', 'name': 'Ponyta', 'number': '77'},
    {'id': '078', 'name': 'Rapidash', 'number': '78'},
    {'id': '079', 'name': 'Slowpoke', 'number': '79'},
    {'id': '080', 'name': 'Slowbro', 'number': '80'},
    {'id': '081', 'name': 'Magnemite', 'number': '81'},
    {'id': '082', 'name': 'Magneton', 'number': '82'},
    {'id': '083', 'name': "Farfetch'd", 'number': '83'},
    {'id': '084', 'name': 'Doduo', 'number': '84'},
    {'id': '085', 'name': 'Dodrio', 'number': '85'},
    {'id': '086', 'name': 'Seel', 'number': '86'},
    {'id': '087', 'name': 'Dewgong', 'number': '87'},
    {'id': '088', 'name': 'Grimer', 'number': '88'},
    {'id': '089', 'name': 'Muk', 'number': '89'},
    {'id': '090', 'name': 'Shellder', 'number': '90'},
    {'id': '091', 'name': 'Cloyster', 'number': '91'},
    {'id': '092', 'name': 'Gastly', 'number': '92'},
    {'id': '093', 'name': 'Haunter', 'number': '93'},
    {'id': '094', 'name': 'Gengar', 'number': '94'},
    {'id': '095', 'name': 'Onix', 'number': '95'},
    {'id': '096', 'name': 'Drowzee', 'number': '96'},
    {'id': '097', 'name': 'Hypno', 'number': '97'},
    {'id': '098', 'name': 'Krabby', 'number': '98'},
    {'id': '099', 'name': 'Kingler', 'number': '99'},
...
HOENN = [
    ...
    {'id': '351', 'name': 'Castform', 'number': '351'},
    ...
    {'id': '386_f2', 'name': 'Deoxys (Attack Forme)', 'number': '386'},
    {'id': '386_f3', 'name': 'Deoxys (Defense Forme)', 'number': '386'},
    {'id': '386_f4', 'name': 'Deoxys (Speed Forme)', 'number': '386'},
]
...
SINNOH = [
    ...
    {'id': '412', 'name': 'Burmy (Plant Cloak)', 'number': '412'},
    {'id': '412_f2', 'name': 'Burmy (Sandy Cloak)', 'number': '412'},
    {'id': '412_f3', 'name': 'Burmy (Trash Cloak)', 'number': '412'},
    {'id': '413', 'name': 'Wormadam (Plant Cloak)', 'number': '413'},
    {'id': '413_f2', 'name': 'Wormadam (Sandy Cloak)', 'number': '413'},
    {'id': '413_f3', 'name': 'Wormadam (Trash Cloak)', 'number': '413'},
    ...
    {'id': '421', 'name': 'Cherrim (Overcast Form)', 'number': '421'},
    {'id': '421_f2', 'name': 'Cherrim (Sunshine Form)', 'number': '421'},
    {'id': '422', 'name': 'Shellos (West Sea)', 'number': '422'},
    {'id': '422_f2', 'name': 'Shellos (East Sea)', 'number': '422'},
    {'id': '423', 'name': 'Gastrodon (West Sea)', 'number': '423'},
    {'id': '423_f2', 'name': 'Gastrodon (East Sea)', 'number': '423'},
    ...
    {'id': '479_f2', 'name': 'Heat Rotom', 'number': '479'},
    {'id': '479_f3', 'name': 'Wash Rotom', 'number': '479'},
    {'id': '479_f4', 'name': 'Frost Rotom', 'number': '479'},
    {'id': '479_f5', 'name': 'Fan Rotom', 'number': '479'},
    {'id': '479_f6', 'name': 'Mow Rotom', 'number': '479'},
    ...
    {'id': '487', 'name': 'Giratina (Altered Forme)', 'number': '487'},
    {'id': '487_f2', 'name': 'Giratina (Origin Forme)', 'number': '487'},
    ...
    {'id': '492', 'name': 'Shaymin (Land Forme)', 'number': '492'},
    {'id': '492_f2', 'name': 'Shaymin (Sky Forme)', 'number': '492'},
...
UNOVA = [
    ...
    {'id': '521', 'name': 'Unfezant (Male)', 'number': '521'},
    {'id': '521_f2', 'name': 'Unfezant (Female)', 'number': '521'},
    ...
    {'id': '550', 'name': 'Basculin (Red-Striped Form)', 'number': '550'},
    {'id': '550_f2', 'name': 'Basculin (Blue-Striped Form)', 'number': '550'},
    ...
    {'id': '555', 'name': 'Darmanitan', 'number': '555'},
    ...
    {'id': '585', 'name': 'Deerling (Spring Form)', 'number': '585'},
    {'id': '585_f2', 'name': 'Deerling (Summer Form)', 'number': '585'},
    {'id': '585_f3', 'name': 'Deerling (Autumn Form)', 'number': '585'},
    {'id': '585_f4', 'name': 'Deerling (Winter Form)', 'number': '585'},
    {'id': '586', 'name': 'Sawsbuck (Spring Form)', 'number': '586'},
    {'id': '586_f2', 'name': 'Sawsbuck (Summer Form)', 'number': '586'},
    {'id': '586_f3', 'name': 'Sawsbuck (Autumn Form)', 'number': '586'},
    {'id': '586_f4', 'name': 'Sawsbuck (Winter Form)', 'number': '586'},
    ...
    {'id': '592', 'name': 'Frillish (Male)', 'number': '592'},
    {'id': '592_f2', 'name': 'Frillish (Female)', 'number': '592'},
    {'id': '593', 'name': 'Jellicent (Male)', 'number': '593'},
    {'id': '593_f2', 'name': 'Jellicent (Female)', 'number': '593'},
    ...
    {'id': '641', 'name': 'Tornadus (Incarnate Forme)', 'number': '641'},
    {'id': '641_f2', 'name': 'Tornadus (Therian Forme)', 'number': '641'},
    {'id': '642', 'name': 'Thundurus (Incarnate Forme)', 'number': '642'},
    {'id': '642_f2', 'name': 'Thundurus (Therian Forme)', 'number': '642'},
    {'id': '643', 'name': 'Reshiram', 'number': '643'},
    {'id': '644', 'name': 'Zekrom', 'number': '644'},
    {'id': '645', 'name': 'Landorus (Incarnate Forme)', 'number': '645'},
    {'id': '645_f2', 'name': 'Landorus (Therian Forme)', 'number': '645'},
    {'id': '646', 'name': 'Kyurem', 'number': '646'},
    {'id': '646_f2', 'name': 'White Kyurem', 'number': '646'},
    {'id': '646_f3', 'name': 'Black Kyurem', 'number': '646'},
    {'id': '647', 'name': 'Keldeo (Ordinary Form)', 'number': '647'},
    {'id': '647_f2', 'name': 'Keldeo (Resolute Form)', 'number': '647'},
    {'id': '648', 'name': 'Meloetta (Aria Forme)', 'number': '648'},
    {'id': '648_f2', 'name': 'Meloetta (Pirouette Forme)', 'number': '648'},
    {'id': '649', 'name': 'Genesect', 'number': '649'},
]

# https://bulbapedia.bulbagarden.net/wiki/Mega_Evolution#Pok.C3.A9mon_capable_of_Mega_Evolution
KALOS_MEGA = [
    {'id': '003_f2', 'name': 'Mega Venusaur', 'number': '3'},
    {'id': '006_f2', 'name': 'Mega Charizard X', 'number': '6'},
    {'id': '006_f3', 'name': 'Mega Charizard Y', 'number': '6'},
    {'id': '009_f2', 'name': 'Mega Blastoise', 'number': '9'},
    {'id': '015_f2', 'name': 'Mega Beedrill', 'number': '15'},
    {'id': '018_f2', 'name': 'Mega Pidgeot', 'number': '18'},
    {'id': '065_f2', 'name': 'Mega Alakazam', 'number': '65'},
    {'id': '080_f2', 'name': 'Mega Slowbro', 'number': '80'},
    {'id': '094_f2', 'name': 'Mega Gengar', 'number': '94'},
    {'id': '115_f2', 'name': 'Mega Kangaskhan', 'number': '115'},
    {'id': '127_f2', 'name': 'Mega Pinsir', 'number': '127'},
    {'id': '130_f2', 'name': 'Mega Gyarados', 'number': '130'},
    {'id': '142_f2', 'name': 'Mega Aerodactyl', 'number': '142'},
    {'id': '150_f2', 'name': 'Mega Mewtwo X', 'number': '150'},
    {'id': '150_f3', 'name': 'Mega Mewtwo Y', 'number': '150'},
    {'id': '181_f2', 'name': 'Mega Ampharos', 'number': '181'},
    {'id': '208_f2', 'name': 'Mega Steelix', 'number': '208'},
    {'id': '212_f2', 'name': 'Mega Scizor', 'number': '212'},
    {'id': '214_f2', 'name': 'Mega Heracross', 'number': '214'},
    {'id': '229_f2', 'name': 'Mega Houndoom', 'number': '229'},
    {'id': '248_f2', 'name': 'Mega Tyranitar', 'number': '248'},
    {'id': '254_f2', 'name': 'Mega Sceptile', 'number': '254'},
    {'id': '257_f2', 'name': 'Mega Blaziken', 'number': '257'},
    {'id': '260_f2', 'name': 'Mega Swampert', 'number': '260'},
    {'id': '282_f2', 'name': 'Mega Gardevoir', 'number': '282'},
    {'id': '302_f2', 'name': 'Mega Sableye', 'number': '302'},
    {'id': '303_f2', 'name': 'Mega Mawile', 'number': '303'},
    {'id': '306_f2', 'name': 'Mega Aggron', 'number': '306'},
    {'id': '308_f2', 'name': 'Mega Medicham', 'number': '308'},
    {'id': '310_f2', 'name': 'Mega Manectric', 'number': '310'},
    {'id': '319_f2', 'name': 'Mega Sharpedo', 'number': '319'},
    {'id': '323_f2', 'name': 'Mega Camerupt', 'number': '323'},
    {'id': '334_f2', 'name': 'Mega Altaria', 'number': '334'},
    {'id': '354_f2', 'name': 'Mega Banette', 'number': '354'},
    {'id': '359_f2', 'name': 'Mega Absol', 'number': '359'},
    {'id': '362_f2', 'name': 'Mega Glalie', 'number': '362'},
    {'id': '373_f2', 'name': 'Mega Salamence', 'number': '373'},
    {'id': '376_f2', 'name': 'Mega Metagross', 'number': '376'},
    {'id': '380_f2', 'name': 'Mega Latias', 'number': '380'},
    {'id': '381_f2', 'name': 'Mega Latios', 'number': '381'},
    {'id': '384_f2', 'name': 'Mega Rayquaza', 'number': '384'},
    {'id': '428_f2', 'name': 'Mega Lopunny', 'number': '428'},
    {'id': '445_f2', 'name': 'Mega Garchomp', 'number': '445'},
    {'id': '448_f2', 'name': 'Mega Lucario', 'number': '448'},
    {'id': '460_f2', 'name': 'Mega Abomasnow', 'number': '460'},
    {'id': '475_f2', 'name': 'Mega Gallade', 'number': '475'},
    {'id': '531_f2', 'name': 'Mega Audino', 'number': '531'},
    {'id': '719_f2', 'name': 'Mega Diancie', 'number': '719'},
]

# # https://bulbapedia.bulbagarden.net/wiki/Primal_Reversion#Pok.C3.A9mon_capable_of_Primal_Reversion
KALOS_PRIMAL_REVERSION = [
    {'id': '382_f2', 'name': 'Primal Kyogre', 'number': '382'},
    {'id': '383_f2', 'name': 'Primal Groudon', 'number': '383'},
]
...
KALOS = [
    ...
    {'id': '658', 'name': 'Ash-Greninja', 'number': '658'},
    ...
    {'id': '666', 'name': 'Vivillon (Meadow Pattern)', 'number': '666'},
    {'id': '666_f2', 'name': 'Vivillon (Continental Pattern)', 'number': '666'},
    {'id': '666_f3', 'name': 'Vivillon (Garden Pattern)', 'number': '666'},
    {'id': '666_f4', 'name': 'Vivillon (Elegant Pattern)', 'number': '666'},
    {'id': '666_f5', 'name': 'Vivillon (Marine Pattern)', 'number': '666'},
    {'id': '666_f6', 'name': 'Vivillon (High Plains Pattern)', 'number': '666'},
    {'id': '666_f7', 'name': 'Vivillon (River Pattern)', 'number': '666'},
    {'id': '667', 'name': 'Litleo', 'number': '667'},
    {'id': '668', 'name': 'Pyroar (Male)', 'number': '668'},
    {'id': '668_f2', 'name': 'Pyroar (Female)', 'number': '668'},
    ...
    {'id': '676_f2', 'name': 'Furfrou (Heart Trim)', 'number': '676'},
    {'id': '676_f3', 'name': 'Furfrou (Star Trim)', 'number': '676'},
    {'id': '676_f4', 'name': 'Furfrou (Diamond Trim)', 'number': '676'},
    {'id': '677', 'name': 'Espurr', 'number': '677'},
    {'id': '678', 'name': 'Meowstic (Male)', 'number': '678'},
    {'id': '678_f2', 'name': 'Meowstic (Female)', 'number': '678'},
    {'id': '679', 'name': 'Honedge', 'number': '679'},
    {'id': '680', 'name': 'Doublade', 'number': '680'},
    {'id': '681', 'name': 'Aegislash (Shield Forme)', 'number': '681'},
    {'id': '681_f2', 'name': 'Aegislash (Blade Forme)', 'number': '681'},
    ...
    {'id': '710', 'name': 'Pumpkaboo', 'number': '710'},
    {'id': '711', 'name': 'Gourgeist', 'number': '711'},
    ...
    {'id': '718_f2', 'name': 'Zygarde (10% Forme)', 'number': '718'},
    {'id': '718_f3', 'name': 'Zygarde (Complete Forme)', 'number': '718'},
    {'id': '719', 'name': 'Diancie', 'number': '719'},
    {'id': '720', 'name': 'Hoopa (Confined)', 'number': '720'},
    {'id': '720_f2', 'name': 'Hoopa (Unbound)', 'number': '720'},
    {'id': '721', 'name': 'Volcanion', 'number': '721'},
]

# https://bulbapedia.bulbagarden.net/wiki/Regional_form#List_of_Alolan_Forms
ALOLA_FORMS = [
    {'id': '019_f2', 'name': 'Alolan Rattata', 'number': '19'},
    {'id': '020_f2', 'name': 'Alolan Raticate', 'number': '20'},
    {'id': '026_f2', 'name': 'Alolan Raichu', 'number': '26'},
    {'id': '027_f2', 'name': 'Alolan Sandshrew', 'number': '27'},
    {'id': '028_f2', 'name': 'Alolan Sandslash', 'number': '28'},
    {'id': '037_f2', 'name': 'Alolan Vulpix', 'number': '37'},
    {'id': '038_f2', 'name': 'Alolan Ninetales', 'number': '38'},
    {'id': '050_f2', 'name': 'Alolan Diglett', 'number': '50'},
    {'id': '051_f2', 'name': 'Alolan Dugtrio', 'number': '51'},
    {'id': '052_f2', 'name': 'Alolan Meowth', 'number': '52'},
    {'id': '053_f2', 'name': 'Alolan Persian', 'number': '53'},
    {'id': '074_f2', 'name': 'Alolan Geodude', 'number': '74'},
    {'id': '075_f2', 'name': 'Alolan Graveler', 'number': '75'},
    {'id': '076_f2', 'name': 'Alolan Golem', 'number': '76'},
    {'id': '088_f2', 'name': 'Alolan Grimer', 'number': '88'},
    {'id': '089_f2', 'name': 'Alolan Muk', 'number': '89'},
    {'id': '103_f2', 'name': 'Alolan Exeggutor', 'number': '103'},
    {'id': '105_f2', 'name': 'Alolan Marowak', 'number': '105'},
]
...
ALOLA = [
    ...
    {'id': '741', 'name': 'Oricorio (Baile Style)', 'number': '741'},
    {'id': '741_f2', 'name': 'Oricorio (Pom-Pom Style)', 'number': '741'},
    {'id': "741_f3", 'name': "Oricorio (Pa'u Style)", 'number': '741'},
    {'id': '741_f4', 'name': 'Oricorio (Sensu Style)', 'number': '741'},
    ...
    {'id': '745_f2', 'name': 'Lycanroc (Midnight Form)', 'number': '745'},
    {'id': '745_f3', 'name': 'Lycanroc (Dusk Form)', 'number': '745'},
    {'id': '746', 'name': 'Wishiwashi (Solo Form)', 'number': '746'},
    {'id': '746_f2', 'name': 'Wishiwashi (School Form)', 'number': '746'},
    ...
    {'id': '774_f2', 'name': 'Minior (Core)', 'number': '774'},
    ...
    {'id': '800_f2', 'name': 'Dusk Mane Necrozma', 'number': '800'},
    {'id': '800_f3', 'name': 'Dawn Wings Necrozma', 'number': '800'},
    {'id': '800_f4', 'name': 'Ultra Necrozma', 'number': '800'},
    ...
    {'id': '809_f2', 'name': 'Gigantamax Melmetal', 'number': '809'},
]

# https://bulbapedia.bulbagarden.net/wiki/Regional_form#List_of_Galarian_Forms
GALAR_FORMS = [
    {'id': '052_f3', 'name': 'Galarian Meowth', 'number': '52'},
    {'id': '077_f2', 'name': 'Galarian Ponyta', 'number': '77'},
    {'id': '078_f2', 'name': 'Galarian Rapidash', 'number': '78'},
    {'id': '079_f2', 'name': 'Galarian Slowpoke', 'number': '79'},
    {'id': '080_f3', 'name': 'Galarian Slowbro', 'number': '80'},
    {'id': '083_f2', 'name': "Galarian Farfetch'd", 'number': '83'},
    {'id': '110_f2', 'name': 'Galarian Weezing', 'number': '110'},
    {'id': '122_f2', 'name': 'Galarian Mr. Mime', 'number': '122'},
    {'id': '144_f2', 'name': 'Galarian Articuno', 'number': '144'},
    {'id': '145_f2', 'name': 'Galarian Zapdos', 'number': '145'},
    {'id': '146_f2', 'name': 'Galarian Moltres', 'number': '146'},
    {'id': '199_f2', 'name': 'Galarian Slowking', 'number': '199'},
    {'id': '222_f2', 'name': 'Galarian Corsola', 'number': '222'},
    {'id': '263_f2', 'name': 'Galarian Zigzagoon', 'number': '263'},
    {'id': '264_f2', 'name': 'Galarian Linoone', 'number': '264'},
    {'id': '554_f2', 'name': 'Galarian Darumaka', 'number': '554'},
    {'id': '555_f2', 'name': 'Galarian Darmanitan (Standard Mode)', 'number': '555'},
    {'id': '562_f2', 'name': 'Galarian Yamask', 'number': '562'},
    {'id': '618_f2', 'name': 'Galarian Stunfisk', 'number': '618'},
]

# https://bulbapedia.bulbagarden.net/wiki/Gigantamax#Gigantamax_Pok.C3.A9mon
GALAR_GIGANTAMAX = [
    {'id': '003_f3', 'name': 'Gigantamax Venusaur', 'number': '3'},
    {'id': '006_f4', 'name': 'Gigantamax Charizard', 'number': '6'},
    {'id': '009_f3', 'name': 'Gigantamax Blastoise', 'number': '9'},
    {'id': '012_f2', 'name': 'Gigantamax Butterfree', 'number': '12'},
    {'id': '025_f2', 'name': 'Gigantamax Pikachu', 'number': '25'},
    {'id': '052_f4', 'name': 'Gigantamax Meowth', 'number': '52'},
    {'id': '068_f2', 'name': 'Gigantamax Machamp', 'number': '68'},
    {'id': '094_f3', 'name': 'Gigantamax Gengar', 'number': '94'},
    {'id': '099_f2', 'name': 'Gigantamax Kingler', 'number': '99'},
    {'id': '131_f2', 'name': 'Gigantamax Lapras', 'number': '131'},
    {'id': '133_f2', 'name': 'Gigantamax Eevee', 'number': '133'},
    {'id': '143_f2', 'name': 'Gigantamax Snorlax', 'number': '143'},
    {'id': '569_f2', 'name': 'Gigantamax Garbodor', 'number': '569'},
    {'id': '812_f2', 'name': 'Gigantamax Rillaboom', 'number': '812'},
    {'id': '815_f2', 'name': 'Gigantamax Cinderace', 'number': '815'},
    {'id': '818_f2', 'name': 'Gigantamax Inteleon', 'number': '818'},
    {'id': '823_f2', 'name': 'Gigantamax Corviknight', 'number': '823'},
    {'id': '826_f2', 'name': 'Gigantamax Orbeetle', 'number': '826'},
    {'id': '834_f2', 'name': 'Gigantamax Drednaw', 'number': '834'},
    {'id': '839_f2', 'name': 'Gigantamax Coalossal', 'number': '839'},
    {'id': '841_f2', 'name': 'Gigantamax Flapple', 'number': '841'},
    {'id': '842_f2', 'name': 'Gigantamax Appletun', 'number': '842'},
    {'id': '844_f2', 'name': 'Gigantamax Sandaconda', 'number': '844'},
    {'id': '849_f3', 'name': 'Gigantamax Toxtricity', 'number': '849'},
    {'id': '851_f2', 'name': 'Gigantamax Centiskorch', 'number': '851'},
    {'id': '858_f2', 'name': 'Gigantamax Hatterene', 'number': '858'},
    {'id': '861_f2', 'name': 'Gigantamax Grimmsnarl', 'number': '861'},
    {'id': '869_f2', 'name': 'Gigantamax Alcremie', 'number': '869'},
    {'id': '879_f2', 'name': 'Gigantamax Copperajah', 'number': '879'},
    {'id': '884_f2', 'name': 'Gigantamax Duraludon', 'number': '884'},
    {'id': '892_f3', 'name': 'Gigantamax Urshifu (Single Strike Style)', 'number': '892'},
    {'id': '892_f4', 'name': 'Gigantamax Urshifu (Rapid Strike Style)', 'number': '892'},
]
...
GALAR = [
    ...
    {'id': '849', 'name': 'Toxtricity (Low Key Form)', 'number': '849'},
    {'id': '849_f2', 'name': 'Toxtricity (Amped Form)', 'number': '849'},
    ...
    {'id': '875', 'name': 'Eiscue (Ice Face)', 'number': '875'},
    {'id': '876', 'name': 'Indeedee (Male)', 'number': '876'},
    {'id': '876_f2', 'name': 'Indeedee (Female)', 'number': '876'},
    {'id': '877', 'name': 'Morpeko (Full Belly Mode)', 'number': '877'},
    {'id': '877_f2', 'name': 'Morpeko (Hangry Mode)', 'number': '877'},
    ...
    {'id': '888', 'name': 'Zacian (Hero of Many Battles)', 'number': '888'},
    {'id': '888_f2', 'name': 'Zacian (Crowned Sword)', 'number': '888'},
    {'id': '889', 'name': 'Zamazenta (Hero of Many Battles)', 'number': '889'},
    {'id': '889_f2', 'name': 'Zamazenta (Crowned Sword)', 'number': '889'},
    {'id': '890', 'name': 'Eternatus', 'number': '890'},
    {'id': '891', 'name': 'Kubfu', 'number': '891'},
    {'id': '892', 'name': 'Urshifu (Single Strike Style)', 'number': '892'},
    {'id': '892_f2', 'name': 'Urshifu (Rapid Strike Style)', 'number': '892'},
    ...
    {'id': '898_f2', 'name': 'Ice Rider Calyrex', 'number': '898'},
    {'id': '898_f3', 'name': 'Shadow Rider Calyrex', 'number': '898'},
]
