...
def main():
    parser = ArgumentParser(description='A tiny program to dowload HD Pokémon Icons from The Silph Road')
    subparsers = parser.add_subparsers(title='Commands', dest='command')

    subparser = subparsers.add_parser('icons', help='Download Pokémon icons from the specified region(s).')
    subparser.add_argument('--region', type=str, choices=['Kanto', 'Johto', 'Hoenn', 'Sinnoh', 'Unova', 'Kalos', 'Alola', 'Galar'],
